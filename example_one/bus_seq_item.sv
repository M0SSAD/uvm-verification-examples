...
class bus_seq_item extends uvm_sequence_item;
    ...
    constraint at_least_1 {
        delay insede {[1:20]}; // delay must be constrained between 1 to 20 cycles.
    }
    ...
    // Further constraints could be added by inheriting from this class and addin specified constraints on the sequence item
